...
\repeat unfold 128 { hh8 hh <sn hh> hh hh hh <sn hh> hh | }
                    }
                }
...
\key aes \major
\ottava #1
\repeat unfold 8 { ees128\mp ees' } \repeat unfold 8 { aes,128 aes' } \repeat unfold 8 { bes,128 bes' } \repeat unfold 8 { aes,128 aes' } \repeat unfold 8 { ees128 ees' } \repeat unfold 8 { aes,,128 aes' } \repeat unfold 8 { bes,128 bes' } \repeat unfold 8 { aes,128 aes' } |
\repeat unfold 127 { \repeat unfold 8 { ees,128 ees' } \repeat unfold 8 { aes,128 aes' } \repeat unfold 8 { bes,128 bes' } \repeat unfold 8 { aes,128 aes' } \repeat unfold 8 { ees128 ees' } \repeat unfold 8 { aes,,128 aes' } \repeat unfold 8 { bes,128 bes' } \repeat unfold 8 { aes,128 aes' } | }
\ottava #0
                    }
                >>
            >>
