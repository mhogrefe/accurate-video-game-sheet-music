...
\clef bass
\repeat unfold 4 { bes4. r4 r8 | }
bes4. r4 r8 bes4. |
bes4 4 4 |
\override TupletBracket.bracket-visibility = ##f
\tuplet 3/2 { bes16 bes \set stemRightBeamCount = 1 bes } \repeat unfold 4 { \tuplet 3/2 { \set stemLeftBeamCount = 1 bes16 bes \set stemRightBeamCount = 1 bes } } \tuplet 3/2 { \set stemLeftBeamCount = 1 bes16 bes bes } |
bes4. r4 r8 |
                }
            >>
        }
