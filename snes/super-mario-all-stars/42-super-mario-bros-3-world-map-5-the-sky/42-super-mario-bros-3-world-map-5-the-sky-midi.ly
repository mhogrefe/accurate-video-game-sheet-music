...
\repeat unfold 4 {
r4 \tuplet 3/2 { <e g c>4 8 r4 c8 } <e g c>4 |
r2 r4 \tuplet 3/2 { <e g c>4 8 } |
r4 \tuplet 3/2 { <a c f>4 8 r4 f8 } <a c f>4 |
r2 r4 \tuplet 3/2 { <a c f>4 8 } |
}
                }
            >>
        }
