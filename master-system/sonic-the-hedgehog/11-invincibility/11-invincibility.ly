...
\repeat unfold 2 { r8 <a, cis>4. <b dis>4-. \tweak Parentheses.font-size 0 \parenthesize <b dis>4-. | }
<<{
\tuplet 3/2 { b'8[ cis dis] } \tuplet 3/2 { e8 fis gis } \tuplet 3/2 { dis8[ e fis] } \tuplet 3/2 { gis8 a b } |
\tuplet 3/2 { e,8[ fis gis] } \tuplet 3/2 { ais8 b cis } \tuplet 3/2 { fis,8[ gis ais] } \tuplet 3/2 { b8 cis dis } |
}\\{
\repeat unfold 2 { r8 cis,,4. dis4-. \parenthesize dis-. | }
}>>
                    }
...
\repeat percent 4 { bd8 sn4 bd8 sn4 bd8 sn | }
                    }
                }
            >>
        }
